            ...
            <div class="col-xl-6 col-lg-4 col-md-6 mrb-30">
                <div class="team-item d-flex flex-wrap align-items-center justify-content-between">
                    <div class="team-thumb">
                        <img src="<?php echo e(getImage(getFilePath('doctorProfile').'/'. @$doctor->image, getFileSize('doctorProfile'))); ?> " alt="<?php echo app('translator')->get('doctor-image'); ?>">
                        ...
                        <div class="team-content">
                            ...
                            <div class="booking-btn">
                                ...
                                <a href="<?php echo e(route('doctors.booking',$doctor->id)); ?>" class="cmn-btn"><?php echo app('translator')->get('Book Now'); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\wamp64\www\Laravel\docrib\core\resources\views/templates/basic/sections/feature.blade.php ENDPATH**/ ?>