    ...
    <div class="login-main" style="background-image: url('{{ asset('assets/admin/images/login.jpg') }}')">
        <div class="container custom-container d-flex justify-content-center">
            <div class="login-area">
                ...
                <form action="{{ route('doctor.password.verify.code') }}" method="POST" class="login-form w-100">
                    @csrf
                    ...
                    <div class="d-flex flex-wrap justify-content-between">
                        <a href="{{ route('doctor.password.reset') }}" class="forget-text">@lang('Try to send again')</a>
                    </div>
                    <button type="submit" class="btn cmn-btn w-100 mt-4">@lang('Submit')</button>
                </form>
                <a href="{{ route('doctor.login') }}" class="text-white mt-4"><i class="las la-sign-in-alt" aria-hidden="true"></i>@lang('Back to Login')</a>
            </div>
        </div>
    </div>
