    ...
    <div class="login-main" style="background-image: url('{{ asset('assets/admin/images/login.jpg') }}')">
        <div class="container custom-container d-flex justify-content-center">
            <div class="login-area">
                ...
                <form action="{{ route('patient.password.verify.code') }}" method="POST" class="login-form w-100">
                    @csrf
                    ...
                    <div class="d-flex flex-wrap justify-content-between">
                        <a href="{{ route('patient.password.reset') }}" class="forget-text">@lang('Try to send again')</a>
                    </div>
                    <button type="submit" class="btn cmn-btn w-100 mt-4">@lang('Submit')</button>
                </form>
                <a href="{{ route('patient.login') }}" class="text-white mt-4"><i class="las la-sign-in-alt"
